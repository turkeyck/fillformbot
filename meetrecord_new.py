...
def add_record(n, info, first_time_info = first_time_info):
    ...
    for i in range(n):
        ...
        #--------------------------------------------------------------------------------------------
            ...
            if info[i]["num"] == 1:
                ...
                start_date = driver.find_element(By.NAME, 'sogpNameList.termStartDate')
                start_date.clear()
                start_date.send_keys(info[i]["start_date"])
                end_date = driver.find_element(By.NAME, 'sogpNameList.termStopDate').send_keys(info[i]["end_date"])
                driver.find_element(By.NAME, 'sogpNameList.historyYN').click()
                ...
                boa_start_date = driver.find_element(By.NAME, 'sogpDirector.termStartDte')
                boa_start_date.clear()
                boa_start_date.send_keys(info[i]["start_date"])
                ...
                sta_start_date = driver.find_element(By.NAME, 'sogpEmp.termStartDte')
                sta_start_date.clear()
                sta_start_date.send_keys(info[i]["start_date"])
